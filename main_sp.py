...
from shared.fk_snowflake import MySnowpark
    ...
    with tab1:
        ...
        with f2c3.container(border=True):
            peso_metric = db_obj.get_metric_values('PESO_NETO',
                                                ...
                                                partida=tariff_query,
                                                fecha=date_query)
            st.metric(label='**Peso neto**', value=millify(peso_metric, precision=2))
        ...
        with f2c4.container(border=True):
            partidas_metric = db_obj.get_metric_values('PARTIDA',
                                                    ...
                                                    partida=tariff_query,
                                                    fecha=date_query)
            st.metric(label='**# partidas**', value=millify(partidas_metric, precision=2))
        ...
        with f2c5.container(border=True):
            operaciones_metric = db_obj.get_metric_values('PARTIDA',
                                                        ...
                                                        partida=tariff_query,
                                                        fecha=date_query)
            st.metric(label='**Operaciones**', value=millify(operaciones_metric, precision=2))
        ...
        with f3c2.container(border=True):
            ...
            datos_grafica['FOB'] = datos_grafica['FOB'].apply(lambda x: float(x))
        ...
        with f4c1.container(border=True):
            ...
            num_impo_plot = st.number_input('Importadores a visualizar',
                                            ...
                                            value=default_value,
                                            step=5)
            participacion_importador['PARTICIPACION'] = participacion_importador['PARTICIPACION'].apply(lambda x: float(x))
        ...
        with f4c2.container(border=True):
            ...
            num_prov_plot = st.number_input('Proveedores a visualizar',
                                            ...
                                            value=default_value,
                                            step=5)
            participacion_proveedor['PARTICIPACION'] = participacion_importador['PARTICIPACION'].apply(lambda x: float(x))
        ...
        with f4c3.container(border=True):
            ...
            num_country_plot = st.number_input('Países a visualizar',
                                        ...
                                        value=default_value,
                                        step=5)
            participacion_pais['PARTICIPACION'] = participacion_importador['PARTICIPACION'].apply(lambda x: float(x))
