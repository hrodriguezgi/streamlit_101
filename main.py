...
def get_filters(data):
    # CREATE THE FILTERS
    supplier_list = list(data['PROVEEDOR'].unique())
    supplier_list.sort()

    importer_list = list(data['IMPORTADOR'].unique())
    importer_list.sort()

    country_src_list = list(data['PAIS_ORIGEN'].unique())
    country_src_list.sort()

    country_pro_list = list(data['PAIS_PROCEDENCIA'].unique())
    country_pro_list.sort()

    start_date = data['FECHA'].min()
    end_date = data['FECHA'].max()

    tariff_list = list(data['PARTIDA'].unique())
    tariff_list.sort()

    return supplier_list, importer_list, country_src_list, country_src_list, country_pro_list, start_date, end_date, tariff_list
...
if __name__ == '__main__':
    ...
    supplier_list, importer_list, country_src_list, country_src_list, country_pro_list, start_date, end_date, tariff_list = get_filters(datos)
